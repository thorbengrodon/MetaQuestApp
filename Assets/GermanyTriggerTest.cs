...
public class GermanyTriggerTest : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            label1.text = XYTest.germany_france[0].ToString() + " GWH";
            label2.text = XYTest.germany_austria[0].ToString() + " GWH";
            label3.text = XYTest.germany_poland[0].ToString() + " GWH";
            label4.text = XYTest.germany_czechia[0].ToString() + " GWH";
            label5.text = XYTest.germany_netherland[0].ToString() + " GWH";
        }
